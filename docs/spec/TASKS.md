...
| M3.5 | Live TV UI: channel list + play | AI-Agent | 0.75 | [ui] | M3.4, M2.4 | — | todo |
...
| M3.14 | Connector failure fallbacks & rate limits | AI-Agent | 0.5 | [backend][security] | M3.1–M3.3 | ✓ | todo |
| M3.15 | Live TV EPG-lite (optional) | AI-Agent | 0.75 | [backend][ui] | M3.4, M3.5 | ✓ | todo |
| M3.16 | Subtitle font pack & fallback rules | AI-Agent | 0.25 | [ui] | M2.6 | ✓ | todo |
